...
#
# Commands:
#   megumi github status - Returns the current system status and timestamp.
#   megumi github status last - Returns the last human communication, status, and timestamp.
#   megumi github status messages - Returns the most recent human communications with status and timestamp.
#
# Author:
#   voke
