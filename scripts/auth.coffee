...
#
# Commands:
#   megumi <user> has <role> role - Assigns a role to a user
#   megumi <user> doesn't have <role> role - Removes a role from a user
#   megumi what role does <user> have - Find out what roles are assigned to a specific user
#   megumi who has admin role - Find out who's an admin and can assign roles
#
# Notes:
