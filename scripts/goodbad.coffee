...
#
# Commands:
#   megumi good <good thing> - Add something good that happened this sprint
#   megumi bad <bad thing> - Add something bad that happened this sprint
#   megumi goodlist - List all good things that happened
#   megumi badlist - List all bad things that happened
#   megumi gooddel - Delete all good things that happened
#   megumi baddel - Delete all bad things that happened
#
# Author:
#   gabeguz
