...
#
# Commands:
#   megumi take scrum notes - Starts taking notes from all users in the room (records all messages starting with yesterday, today, tomorrow, sun, mon, tue, wed, thu, fri, sat, blocking)
#   megumi stop taking notes - Stops taking scrum notes (if a path is configured saves day notes to a json file)
#   megumi scrum notes - shows scrum notes taken so far
#   megumi are you taking notes? - hubot indicates if he's currently taking notes
#
# Author:
#   benjamin eidelman
