...
#
# Commands:
#   megumi heroku status - Returns the current Heroku status for app operations and tools
#   megumi heroku status issues <limit> - Returns a list of recent <limit> issues (default limit is 5)
#   megumi heroku status issue <id> - Returns a single issue by ID number
#
# Author:
#   juno
