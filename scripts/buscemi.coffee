...
#
# Commands:
#   megumi buscemi me <url> - Adds Steve Buscemi eyes to the specified URL
#   megumi buscemi me <query> - Searches Google Images for the specified query and buscemi's it
#
# Author:
#   dylanegan
