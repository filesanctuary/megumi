...
#   megumi karma <thing> - check thing's karma (if <thing> is omitted, show the top 5)
#   megumi karma empty <thing> - empty a thing's karma
#   megumi karma best - show the top 5
#   megumi karma worst - show the bottom 5
#
# Author:
#   stuartf
