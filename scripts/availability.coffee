...
#
# Commands:
#   megumi is <user> available - Find out if the specified user is available or not
#   megumi i am <available|free|not busy|at hand> - Set that you are available
#   megumi i am <unavailable|dnd|do not disturb|busy|in the zone> - Setthat you are not available
