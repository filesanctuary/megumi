...
# Commands:
#
#   megumi remember my harvest account <email> with password <password> - Make hubot remember your Harvest credentials
#   megumi forget my harvest account - Make hubot forget your Harvest credentials again
#   megumi start harvest - Restart the last timer.
#   megumi start harvest at <project>/<task>: <notes> - Start a Harvest timer at a given project-task combination
#   megumi stop harvest [at project/task] - Stop the most recent Harvest timer or the one for the given project-task combination.
#   megumi daily harvest [of <user>] [at yyyy-mm-dd] - Show a user's Harvest timers for today (or yours, if noone is specified) or a specific day
#   megumi list harvest tasks [of <user>] - Show the Harvest project-task combinations available to a user (or you, if noone is specified)
#   megumi is harvest down/up - Check if the Harvest API is reachable.
#
# Notes:
...
#
#   megumi remember my harvest account <email> with password <password>
#     Saves your Harvest credentials to allow Hubot to track
#     time for you.
#
#   megumi forget my harvest account
...
#
#   megumi start harvest at <project>/<task>: <notes>
...
#
#   megumi stop harvest [at <project>/<task>]
...
#
#   megumi daily harvest [of <user>] [on yyyy-mm-dd]
...
#
#   megumi list harvest tasks [of <user>]
